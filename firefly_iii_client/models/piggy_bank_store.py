...
class PiggyBankStore(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accounts", "active", "current_amount", "name", "notes", "object_group_id", "object_group_title", "order", "start_date", "target_amount", "target_date"]
