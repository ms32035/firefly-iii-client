...
class Bill(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "amount_max", "amount_min", "created_at", "currency_code", "currency_decimal_places", "currency_id", "currency_symbol", "date", "end_date", "extension_date", "name", "native_amount_max", "native_amount_min", "native_currency_code", "native_currency_decimal_places", "native_currency_id", "native_currency_symbol", "next_expected_match", "next_expected_match_diff", "notes", "object_group_id", "object_group_order", "object_group_title", "order", "paid_dates", "pay_dates", "repeat_freq", "skip", "updated_at"]
