...
class PiggyBankAttributes(object):
    ...
    def __init__(self, account_id=None, active=None, created_at=None, currency_code=None, currency_decimal_places=None, currency_id=None, currency_symbol=None, current_amount=None, left_to_save=None, name=None, notes=None, order=None, percentage=None, save_per_month=None, start_date=None, target_amount=None, target_date=None, updated_at=None):  # noqa: E501
