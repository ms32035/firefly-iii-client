...
class Attachment(object):
    ...
    def __init__(self, attachable_id=None, attachable_type=None, created_at=None, download_uri=None, filename=None, md5=None, mime=None, model=None, model_id=None, notes=None, size=None, title=None, updated_at=None, upload_uri=None):  # noqa: E501
    ...
    @property
    def model(self):
        """Gets the model of this Attachment.  # noqa: E501

        The object class to which the attachment must be linked.  # noqa: E501

        :return: The model of this Attachment.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this Attachment.

        The object class to which the attachment must be linked.  # noqa: E501

        :param model: The model of this Attachment.  # noqa: E501
        :type: str
        """
        if model is None:
    ...
    @property
    def model_id(self):
        """Gets the model_id of this Attachment.  # noqa: E501

        ID of the model this attachment is linked to.  # noqa: E501

        :return: The model_id of this Attachment.  # noqa: E501
        :rtype: int
        """
    ...
    def model_id(self, model_id):
        """Sets the model_id of this Attachment.

        ID of the model this attachment is linked to.  # noqa: E501

        :param model_id: The model_id of this Attachment.  # noqa: E501
        :type: int
        """
        if model_id is None:
