...
class BudgetLimit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "budget_id", "created_at", "currency_code", "currency_decimal_places", "currency_id", "currency_name", "currency_symbol", "end", "native_amount", "native_currency_code", "native_currency_decimal_places", "native_currency_id", "native_currency_symbol", "notes", "period", "spent", "start", "updated_at"]
