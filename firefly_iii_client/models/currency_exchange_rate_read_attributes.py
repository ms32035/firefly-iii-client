...
class CurrencyExchangeRateReadAttributes(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "date", "from_currency_code", "from_currency_decimal_places", "from_currency_id", "from_currency_symbol", "rate", "to_currency_code", "to_currency_decimal_places", "to_currency_id", "to_currency_symbol", "updated_at"]
