...
class PiggyBankEvent(object):
    ...
    def __init__(self, amount=None, created_at=None, currency_code=None, currency_decimal_places=None, currency_id=None, currency_symbol=None, journal_id=None, transaction_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
