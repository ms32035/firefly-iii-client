...
class Category(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "earned", "name", "native_currency_code", "native_currency_decimal_places", "native_currency_id", "native_currency_symbol", "notes", "spent", "updated_at"]
