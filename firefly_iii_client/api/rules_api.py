...
class RulesApi(object):
    ...
    def delete_rule(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_rule_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def fire_rule(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fire_rule_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def fire_rule_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `fire_rule`")  # noqa: E501
    ...
    def get_rule(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_rule_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def store_rule(self, rule_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_rule(rule_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RuleUpdate rule_update: JSON array or key=value pairs with the necessary rule information. See the model for the exact specifications. (required)
        :return: RuleSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_rule_with_http_info(rule_update, **kwargs)  # noqa: E501
        else:
            (data) = self.store_rule_with_http_info(rule_update, **kwargs)  # noqa: E501
            return data

    def store_rule_with_http_info(self, rule_update, **kwargs):  # noqa: E501
        """Store a new rule  # noqa: E501

        Creates a new rule. The data required can be submitted as a JSON body or as a list of parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_rule_with_http_info(rule_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['rule_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'rule_update' is set
        if ('rule_update' not in local_var_params or
                local_var_params['rule_update'] is None):
            raise ValueError("Missing the required parameter `rule_update` when calling `store_rule`")  # noqa: E501
        ...
        body_params = None
        if 'rule_update' in local_var_params:
            body_params = local_var_params['rule_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def test_rule(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.test_rule_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def test_rule_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `test_rule`")  # noqa: E501
    ...
    def update_rule(self, id, rule_update, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The ID of the object.X (required)
        :param RuleUpdate rule_update: JSON array with updated rule information. See the model for the exact specifications. (required)
        :return: RuleSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_rule_with_http_info(id, rule_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_rule_with_http_info(id, rule_update, **kwargs)  # noqa: E501
            return data

    def update_rule_with_http_info(self, id, rule_update, **kwargs):  # noqa: E501
        """Update existing rule.  # noqa: E501

        Update existing rule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_rule_with_http_info(id, rule_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'rule_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('rule_update' not in local_var_params or
                local_var_params['rule_update'] is None):
            raise ValueError("Missing the required parameter `rule_update` when calling `update_rule`")  # noqa: E501
