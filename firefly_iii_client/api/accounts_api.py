...
class AccountsApi(object):
    ...
    def get_account_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AccountSingle, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_account(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_account_with_http_info(**kwargs)  # noqa: E501

    def list_account_with_http_info(self, **kwargs):  # noqa: E501
        """List all accounts.  # noqa: E501

        This endpoint returns a list of all the accounts owned by the authenticated user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_account_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def list_attachment_by_account(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_attachment_by_account_with_http_info(id, **kwargs)  # noqa: E501

    def list_attachment_by_account_with_http_info(self, id, **kwargs):  # noqa: E501
        """Lists all attachments.  # noqa: E501

        Lists all attachments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_attachment_by_account_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_attachment_by_account" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `list_attachment_by_account`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/accounts/{id}/attachments', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_piggy_bank_by_account(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_piggy_bank_by_account_with_http_info(id, **kwargs)  # noqa: E501

    def list_piggy_bank_by_account_with_http_info(self, id, **kwargs):  # noqa: E501
        """List all piggy banks related to the account.  # noqa: E501

        This endpoint returns a list of all the piggy banks connected to the account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_piggy_bank_by_account_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_piggy_bank_by_account" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `list_piggy_bank_by_account`")  # noqa: E501
    ...
    def list_transaction_by_account(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_transaction_by_account_with_http_info(id, **kwargs)  # noqa: E501

    def list_transaction_by_account_with_http_info(self, id, **kwargs):  # noqa: E501
        """List all transactions related to the account.  # noqa: E501

        This endpoint returns a list of all the transactions connected to the account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_transaction_by_account_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_transaction_by_account" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `list_transaction_by_account`")  # noqa: E501
    ...
    def store_account(self, account, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_account(account, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param Account account: JSON array with the necessary account information or key=value pairs. See the model for the exact specifications. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.store_account_with_http_info(account, **kwargs)  # noqa: E501

    def store_account_with_http_info(self, account, **kwargs):  # noqa: E501
        """Create new account.  # noqa: E501

        Creates a new account. The data required can be submitted as a JSON body or as a list of parameters (in key=value pairs, like a webform).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_account_with_http_info(account, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('account' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `account` when calling `store_account`")  # noqa: E501
    ...
    def update_account(self, id, account, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_account(id, account, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int id: The ID of the account. (required)
        :param Account account: JSON array or formdata with updated account information. See the model for the exact specifications. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_account_with_http_info(id, account, **kwargs)  # noqa: E501

    def update_account_with_http_info(self, id, account, **kwargs):  # noqa: E501
        """Update existing account.  # noqa: E501

        Used to update a single account. All fields that are not submitted will be cleared (set to NULL). The model will tell you which fields are mandatory.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_account_with_http_info(id, account, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('account' not in local_var_params or  # noqa: E501
                                                        local_var_params['account'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account` when calling `update_account`")  # noqa: E501
