...
class BillsApi(object):
    ...
    def get_attachments_by_bill_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_attachments_by_bill`")  # noqa: E501
    ...
    def get_bill(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param int id: The ID of the bill. (required)
        :param str start: A date formatted YYYY-MM-DD. If it is are added to the request, Firefly III will calculate the appropriate payment and paid dates. 
        :param str end: A date formatted YYYY-MM-DD. If it is added to the request, Firefly III will calculate the appropriate payment and paid dates. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_rules_by_bill_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_rules_by_bill`")  # noqa: E501
    ...
    def get_transactions_by_bill_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_transactions_by_bill`")  # noqa: E501
    ...
    def store_bill_with_http_info(self, bill_update, **kwargs):  # noqa: E501
        ...
        if ('bill_update' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bill_update` when calling `store_bill`")  # noqa: E501
    ...
    def update_bill_with_http_info(self, id, bill_update, **kwargs):  # noqa: E501
        ...
        if ('bill_update' not in local_var_params or
                local_var_params['bill_update'] is None):
            raise ApiValueError("Missing the required parameter `bill_update` when calling `update_bill`")  # noqa: E501
