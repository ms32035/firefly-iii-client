...
class RecurrencesApi(object):
    ...
    def get_transactions_by_recurrence_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_transactions_by_recurrence`")  # noqa: E501
    ...
    def store_recurrence_with_http_info(self, recurrence_update, **kwargs):  # noqa: E501
        ...
        if ('recurrence_update' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `recurrence_update` when calling `store_recurrence`")  # noqa: E501
    ...
    def update_recurrence_with_http_info(self, id, recurrence_update, **kwargs):  # noqa: E501
        ...
        if ('recurrence_update' not in local_var_params or
                local_var_params['recurrence_update'] is None):
            raise ApiValueError("Missing the required parameter `recurrence_update` when calling `update_recurrence`")  # noqa: E501
