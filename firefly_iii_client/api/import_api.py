...
class ImportApi(object):
    ...
    def get_import(self, key, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_import_with_http_info(key, **kwargs)  # noqa: E501
            return data
    ...
    def get_import_with_http_info(self, key, **kwargs):  # noqa: E501
        ...
        if ('key' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `key` when calling `get_import`")  # noqa: E501
    ...
    def get_transactions_by_import(self, key, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_transactions_by_import_with_http_info(key, **kwargs)  # noqa: E501
        else:
            (data) = self.get_transactions_by_import_with_http_info(key, **kwargs)  # noqa: E501
            return data

    def get_transactions_by_import_with_http_info(self, key, **kwargs):  # noqa: E501
        """List all transactions related to the import job. The correlation is made through the tag.  # noqa: E501

        See summary   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions_by_import_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_transactions_by_import" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'key' is set
        if ('key' not in local_var_params or
                local_var_params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get_transactions_by_import`")  # noqa: E501
