...
class LinksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_link_type = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
            ...
            callable=__delete_link_type
        )

        def __delete_transaction_link(
            self,
            id,
            **kwargs
        ):
        ...
        self.delete_transaction_link = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__delete_transaction_link
        )
        ...
        self.get_link_type = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_link_type
        )

        def __get_transaction_link(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_transaction_link = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_transaction_link
        )

        def __list_link_type(
            self,
            **kwargs
        ):
        ...
        self.list_link_type = _Endpoint(
            ...
            api_client=api_client,
            callable=__list_link_type
        )

        def __list_transaction_by_link_type(
            self,
            id,
            **kwargs
        ):
        ...
        self.list_transaction_by_link_type = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_transaction_by_link_type
        )

        def __list_transaction_link(
            self,
            **kwargs
        ):
        ...
        self.list_transaction_link = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_transaction_link
        )

        def __store_link_type(
            self,
            link_type,
            **kwargs
        ):
        ...
        self.store_link_type = _Endpoint(
            settings={
                'response_type': (LinkTypeSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__store_link_type
        )

        def __store_transaction_link(
            self,
        ...
        self.store_transaction_link = _Endpoint(
            settings={
                'response_type': (TransactionLinkSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__store_transaction_link
        )

        def __update_link_type(
            self,
            id,
            link_type_update,
            **kwargs
        ...
        self.update_link_type = _Endpoint(
            settings={
                'response_type': (LinkTypeSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__update_link_type
        )

        def __update_transaction_link(
            self,
            id,
        ...
        self.update_transaction_link = _Endpoint(
            settings={
                'response_type': (TransactionLinkSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__update_transaction_link
        )
