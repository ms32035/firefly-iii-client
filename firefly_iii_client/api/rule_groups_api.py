...
class RuleGroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_rule_group = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
            ...
            callable=__delete_rule_group
        )

        def __fire_rule_group(
            self,
            id,
            **kwargs
        ):
        ...
        self.fire_rule_group = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__fire_rule_group
        )

        def __get_rule_group(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_rule_group = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_rule_group
        )

        def __list_rule_by_group(
            self,
            id,
            **kwargs
        ):
        ...
        self.list_rule_by_group = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_rule_by_group
        )

        def __list_rule_group(
            self,
            **kwargs
        ):
        ...
        self.list_rule_group = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_rule_group
        )

        def __store_rule_group(
            self,
            rule_group_store,
            **kwargs
        ):
        ...
        self.store_rule_group = _Endpoint(
            settings={
                'response_type': (RuleGroupSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__store_rule_group
        )

        def __test_rule_group(
            self,
            id,
            **kwargs
        ):
        ...
        self.test_rule_group = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__test_rule_group
        )

        def __update_rule_group(
            self,
            id,
            rule_group_update,
            **kwargs
        ...
        self.update_rule_group = _Endpoint(
            settings={
                'response_type': (RuleGroupSingle,),
                'auth': [
                    'firefly_iii_auth'
