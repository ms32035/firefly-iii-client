...
class RuleGroupsApi(object):
    ...
    def delete_rule_group_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `delete_rule_group`")  # noqa: E501
    ...
    def get_rule_group_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `get_rule_group`")  # noqa: E501
    ...
    def list_rule_by_group(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_rule_by_group_with_http_info(id, **kwargs)  # noqa: E501

    def list_rule_by_group_with_http_info(self, id, **kwargs):  # noqa: E501
        """List rules in this rule group.  # noqa: E501

        List rules in this rule group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rule_by_group_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_rule_by_group" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `list_rule_by_group`")  # noqa: E501
    ...
    def list_rule_group(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_rule_group_with_http_info(**kwargs)  # noqa: E501

    def list_rule_group_with_http_info(self, **kwargs):  # noqa: E501
        """List all rule groups.  # noqa: E501

        List all rule groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rule_group_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RuleGroupArray, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def store_rule_group(self, rule_group, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_rule_group(rule_group, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param RuleGroup rule_group: JSON array or key=value pairs with the necessary rule group information. See the model for the exact specifications. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.store_rule_group_with_http_info(rule_group, **kwargs)  # noqa: E501

    def store_rule_group_with_http_info(self, rule_group, **kwargs):  # noqa: E501
        """Store a new rule group.  # noqa: E501

        Creates a new rule group. The data required can be submitted as a JSON body or as a list of parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_rule_group_with_http_info(rule_group, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rule_group' not in local_var_params or  # noqa: E501
                                                        local_var_params['rule_group'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rule_group` when calling `store_rule_group`")  # noqa: E501
        ...
        body_params = None
        if 'rule_group' in local_var_params:
            body_params = local_var_params['rule_group']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def test_rule_group_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `test_rule_group`")  # noqa: E501
        ...
        if 'end' in local_var_params and local_var_params['end'] is not None:  # noqa: E501
            query_params.append(('end', local_var_params['end']))  # noqa: E501
        if 'search_limit' in local_var_params and local_var_params['search_limit'] is not None:  # noqa: E501
            query_params.append(('search_limit', local_var_params['search_limit']))  # noqa: E501
        if 'triggered_limit' in local_var_params and local_var_params['triggered_limit'] is not None:  # noqa: E501
    ...
    def update_rule_group(self, id, rule_group, **kwargs):  # noqa: E501
        """Update existing rule group.  # noqa: E501

        Update existing rule group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_rule_group(id, rule_group, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int id: The ID of the rule group. (required)
        :param RuleGroup rule_group: JSON array with updated rule group information. See the model for the exact specifications. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_rule_group_with_http_info(id, rule_group, **kwargs)  # noqa: E501

    def update_rule_group_with_http_info(self, id, rule_group, **kwargs):  # noqa: E501
        """Update existing rule group.  # noqa: E501

        Update existing rule group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_rule_group_with_http_info(id, rule_group, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rule_group' not in local_var_params or  # noqa: E501
                                                        local_var_params['rule_group'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rule_group` when calling `update_rule_group`")  # noqa: E501
