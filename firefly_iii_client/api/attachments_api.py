...
class AttachmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_attachment = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_attachment
        )

        def __store_attachment(
            self,
            attachment_store,
            **kwargs
        ):
        ...
        self.store_attachment = _Endpoint(
            settings={
                'response_type': (AttachmentSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__store_attachment
        )

        def __update_attachment(
            self,
            id,
            attachment_update,
            **kwargs
        ...
        self.update_attachment = _Endpoint(
            settings={
                'response_type': (AttachmentSingle,),
                'auth': [
                    'firefly_iii_auth'
