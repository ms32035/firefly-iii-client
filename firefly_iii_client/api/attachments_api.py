...
class AttachmentsApi(object):
    ...
    def store_attachment(self, attachment_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_attachment(attachment_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AttachmentUpdate attachment_update: JSON array or key=value pairs with the necessary attachment information. See the model for the exact specifications. (required)
        :return: AttachmentSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_attachment_with_http_info(attachment_update, **kwargs)  # noqa: E501
        else:
            (data) = self.store_attachment_with_http_info(attachment_update, **kwargs)  # noqa: E501
            return data

    def store_attachment_with_http_info(self, attachment_update, **kwargs):  # noqa: E501
        """Store a new attachment.  # noqa: E501

        Creates a new attachment. The data required can be submitted as a JSON body or as a list of parameters. You cannot use this endpoint to upload the actual file data (see below). This endpoint only creates the attachment object.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_attachment_with_http_info(attachment_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['attachment_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('attachment_update' not in local_var_params or
                local_var_params['attachment_update'] is None):
            raise ValueError("Missing the required parameter `attachment_update` when calling `store_attachment`")  # noqa: E501
        ...
        body_params = None
        if 'attachment_update' in local_var_params:
            body_params = local_var_params['attachment_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_attachment(self, id, attachment_update, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The ID of the attachment. (required)
        :param AttachmentUpdate attachment_update: JSON array with updated attachment information. See the model for the exact specifications. (required)
        :return: AttachmentSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_attachment_with_http_info(id, attachment_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_attachment_with_http_info(id, attachment_update, **kwargs)  # noqa: E501
            return data

    def update_attachment_with_http_info(self, id, attachment_update, **kwargs):  # noqa: E501
        """Update existing attachment.  # noqa: E501

        Update the meta data for an existing attachment. This endpoint does not allow you to upload or download data. For that, see below.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_attachment_with_http_info(id, attachment_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'attachment_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('attachment_update' not in local_var_params or
                local_var_params['attachment_update'] is None):
            raise ValueError("Missing the required parameter `attachment_update` when calling `update_attachment`")  # noqa: E501
    ...
    def upload_attachment(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.upload_attachment_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def upload_attachment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `upload_attachment`")  # noqa: E501
