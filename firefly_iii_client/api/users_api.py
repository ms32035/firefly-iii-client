...
class UsersApi(object):
    ...
    def store_user(self, user_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_user(user_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserUpdate user_update: JSON array or key=value pairs with the necessary user information. See the model for the exact specifications. (required)
        :return: UserSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_user_with_http_info(user_update, **kwargs)  # noqa: E501
        else:
            (data) = self.store_user_with_http_info(user_update, **kwargs)  # noqa: E501
            return data

    def store_user_with_http_info(self, user_update, **kwargs):  # noqa: E501
        """Store a new user  # noqa: E501

        Creates a new user. The data required can be submitted as a JSON body or as a list of parameters. The user will be given a random password, which they can reset using the \"forgot password\" function.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_user_with_http_info(user_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('user_update' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `user_update` when calling `store_user`")  # noqa: E501
    ...
    def update_user(self, id, user_update, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The user ID. (required)
        :param UserUpdate user_update: JSON array with updated user information. See the model for the exact specifications. (required)
        :return: UserSingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_user_with_http_info(id, user_update, **kwargs)  # noqa: E501
            return data
    ...
    def update_user_with_http_info(self, id, user_update, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'user_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('user_update' not in local_var_params or
                local_var_params['user_update'] is None):
            raise ValueError("Missing the required parameter `user_update` when calling `update_user`")  # noqa: E501
