...
class CategoriesApi(object):
    ...
    def get_transactions_by_category(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions_by_category(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_transactions_by_category_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_transactions_by_category_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_transactions_by_category_with_http_info(self, id, **kwargs):  # noqa: E501
        """List all transactions in a category.  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_transactions_by_category`")  # noqa: E501
    ...
    def store_category(self, category_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_category(category_update, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_category_with_http_info(category_update, **kwargs)  # noqa: E501
        else:
            (data) = self.store_category_with_http_info(category_update, **kwargs)  # noqa: E501
            return data

    def store_category_with_http_info(self, category_update, **kwargs):  # noqa: E501
        """Store a new category  # noqa: E501
        ...
        all_params = ['category_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('category_update' not in local_var_params or
                local_var_params['category_update'] is None):
            raise ValueError("Missing the required parameter `category_update` when calling `store_category`")  # noqa: E501
        ...
        body_params = None
        if 'category_update' in local_var_params:
            body_params = local_var_params['category_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_category(self, id, category_update, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The ID of the category. (required)
        :param CategoryUpdate category_update: JSON array with updated category information. See the model for the exact specifications. (required)
        :return: CategorySingle
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_category_with_http_info(id, category_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_category_with_http_info(id, category_update, **kwargs)  # noqa: E501
            return data

    def update_category_with_http_info(self, id, category_update, **kwargs):  # noqa: E501
        """Update existing category.  # noqa: E501

        Update existing category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_category_with_http_info(id, category_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'category_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_category`")  # noqa: E501
        # verify the required parameter 'category_update' is set
        if ('category_update' not in local_var_params or
                local_var_params['category_update'] is None):
            raise ValueError("Missing the required parameter `category_update` when calling `update_category`")  # noqa: E501
