...
class CategoriesApi(object):
    ...
    def get_transactions_by_category_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_transactions_by_category`")  # noqa: E501
    ...
    def store_category_with_http_info(self, category_update, **kwargs):  # noqa: E501
        ...
        if ('category_update' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `category_update` when calling `store_category`")  # noqa: E501
    ...
    def update_category_with_http_info(self, id, category_update, **kwargs):  # noqa: E501
        ...
        if ('category_update' not in local_var_params or
                local_var_params['category_update'] is None):
            raise ApiValueError("Missing the required parameter `category_update` when calling `update_category`")  # noqa: E501
