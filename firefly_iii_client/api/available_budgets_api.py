...
class AvailableBudgetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_available_budget = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
            ...
            callable=__delete_available_budget
        )

        def __get_available_budget(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_available_budget = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_available_budget
        )

        def __list_available_budget(
            self,
            **kwargs
        ):
        ...
        self.list_available_budget = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_available_budget
        )

        def __store_available_budget(
            self,
        ...
        self.store_available_budget = _Endpoint(
            settings={
                'response_type': (AvailableBudgetSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__store_available_budget
        )

        def __update_available_budget(
            self,
            id,
        ...
        self.update_available_budget = _Endpoint(
            settings={
                'response_type': (AvailableBudgetSingle,),
                'auth': [
                    'firefly_iii_auth'
            ...
            api_client=api_client,
            callable=__update_available_budget
        )
