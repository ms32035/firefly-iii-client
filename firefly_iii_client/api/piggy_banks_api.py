...
class PiggyBanksApi(object):
    ...
    def get_events_by_piggy_bank_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_events_by_piggy_bank`")  # noqa: E501
    ...
    def store_piggy_bank_with_http_info(self, piggy_bank_update, **kwargs):  # noqa: E501
        ...
        if ('piggy_bank_update' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `piggy_bank_update` when calling `store_piggy_bank`")  # noqa: E501
    ...
    def update_piggy_bank_with_http_info(self, id, piggy_bank_update, **kwargs):  # noqa: E501
        ...
        if ('piggy_bank_update' not in local_var_params or
                local_var_params['piggy_bank_update'] is None):
            raise ApiValueError("Missing the required parameter `piggy_bank_update` when calling `update_piggy_bank`")  # noqa: E501
