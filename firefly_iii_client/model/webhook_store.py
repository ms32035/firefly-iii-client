...
class WebhookStore(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, response, title, trigger, url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            delivery (str): Format of the delivered response.. defaults to "DELIVERY_JSON", must be one of ["DELIVERY_JSON", ]  # noqa: E501
        ...
        delivery = kwargs.get('delivery', "DELIVERY_JSON")
    ...
    @convert_js_args_to_python_args
    def __init__(self, response, title, trigger, url, *args, **kwargs):  # noqa: E501
        """WebhookStore - a model defined in OpenAPI
