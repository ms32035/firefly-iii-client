...
class AccountStore(ModelNormal):
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            interest_period (str, none_type): Mandatory when type is liability. Period over which the interest is calculated.. [optional] if omitted the server will use the default value of "monthly"  # noqa: E501
            latitude (float, none_type): Latitude of the accounts's location, if applicable. Can be used to draw a map.. [optional]  # noqa: E501
            liability_direction (str, none_type): 'credit' indicates somebody owes you the liability. 'debit' Indicates you owe this debt yourself. Works only for liabiltiies.. [optional] if omitted the server will use the default value of "debit"  # noqa: E501
