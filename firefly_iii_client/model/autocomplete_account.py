...
class AutocompleteAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency_code, currency_decimal_places, currency_id, currency_symbol, id, name, name_with_balance, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency_code, currency_decimal_places, currency_id, currency_symbol, id, name, name_with_balance, type, *args, **kwargs):  # noqa: E501
        """AutocompleteAccount - a model defined in OpenAPI
