...
class PiggyBankUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "account_id", "active", "currency_code", "currency_id", "current_amount", "notes", "object_group_id", "object_group_title", "order", "start_date", "target_amount", "target_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "account_id", "active", "currency_code", "currency_id", "current_amount", "notes", "object_group_id", "object_group_title", "order", "start_date", "target_amount", "target_date", ], str]):
