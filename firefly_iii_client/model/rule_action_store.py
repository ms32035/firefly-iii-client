...
class RuleActionStore(ModelNormal):
    ...
    def _from_openapi_data(cls, type, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            active (bool): If the action is active. Defaults to true.. [optional]  # noqa: E501
            order (int): Order of the action. [optional]  # noqa: E501
            stop_processing (bool): When true, other actions will not be fired after this action has fired. Defaults to false.. [optional]  # noqa: E501
        """
