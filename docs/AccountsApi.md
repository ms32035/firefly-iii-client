...
> TransactionArray get_transactions_by_account(id, page=page, start=start, end=end, type=type)
...
try:
    # List all transactions related to the account.
    api_response = api_instance.get_transactions_by_account(id, page=page, start=start, end=end, type=type)
    pprint(api_response)
except ApiException as e:
